...
<!-- to dos -->
<!-- 1>bottom tab navigator active color/ inactive color -->


<!-- 2 AppDelegate.m(m) edit file -->
...
<!-- 3>Also make sure that your Podfile deployment target is set to >= 13.0 at the top of your Podfile, eg:
platform :ios, '13.0' -->
...
<!-- appDelegate.mm place the google api keus their` -->
<!-- Google Maps SDK for iOS requires iOS 13, so make sure that your deployment target is >= 13.4 in your iOS project settings. -->


<!-- replacee your key in androidmanifest file AIzaSyAyu-6Pv7RaiohWH1bWpQqwXbx7roNG_GA -->
